...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(
        ...
        try:
            ...
            assert result.negative_gamma_regime is True
            assert (
            ...
            assert feature.negative_gamma_regime is True
            assert (
                feature.negative_gamma_regime_status
                is GateStatus.PASS
            )
            assert feature.directional_flow_confirmation == 0.5
            ...
            assert latest.negative_gamma_regime is True
            assert (
                latest.negative_gamma_regime_status
                is GateStatus.PASS
            )
            assert latest.directional_flow_confirmation == 0.5
