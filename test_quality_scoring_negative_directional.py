...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(
        ...
        try:
            ...
            assert feature.base_score == 65.0
            assert feature.volatility_penalty == 5.0
            assert feature.final_score == 60.0
            assert feature.coverage_points == 80.0
            assert abs(
                feature.coverage_pct
                - (80.0 / 115.0)
            ) < 1e-12
            assert feature.raw_grade == "C"
            assert feature.final_grade == "C"
            ...
            assert latest.base_score == 65.0
            assert latest.final_score == 60.0
            assert latest.coverage_points == 80.0
            assert latest.raw_grade == "C"
            assert latest.final_grade == "C"
